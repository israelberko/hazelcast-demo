package com.k1.demo.rest.errors

import com.k1.demo.rest.HeaderUtil
import com.k1.demo.rest.errors.*
import java.net.URI
 ...
 */
@ControllerAdvice
class ExceptionTranslator(private val env: Environment) : ProblemHandling {
...
//    override fun process(entity: ResponseEntity<Problem>?, request: NativeWebRequest?): ResponseEntity<Problem>? {
    ...
    private fun containsPackageName(message: String?) = listOf("org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.k1.demo").any { it == message }
}
