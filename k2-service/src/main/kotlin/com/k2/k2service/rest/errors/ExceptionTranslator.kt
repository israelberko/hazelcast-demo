...
import com.k2.k2service.rest.HeaderUtil
import com.k2.k2service.rest.errors.*
import java.net.URI
...
//    override fun process(entity: ResponseEntity<Problem>?, request: NativeWebRequest?): ResponseEntity<Problem>? {
    ...
    private fun containsPackageName(message: String?) = listOf("org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.k2.k2service").any { it == message }
}
