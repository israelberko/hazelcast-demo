package com.k2.k2service.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
            "within(com.k2.k2service.repository..*)" +
                    " || within(com.k2.k2service.service..*)" +
                    " || within(com.k2.k2service.rest..*)"
    )
    ...
    fun logAfterThrowing(joinPoint: JoinPoint, e: Throwable) {
        logger(joinPoint).error(
                "Exception in {}() with argument[s]= {} and cause = \'{}\' and exception = \'{}\'",
